% Gerando e plotando uma onda retangular.

clear all;  % Apaga variaveis e seus valores.
close all;  % Fecha janelas.
clc;  % Limpa o terminal.

freq_sinal = 1;  % Frequencia do sinal [Hz] = [ciclos/seg].
T_sinal = 1 / freq_sinal; % Período do sinal [seg].

freq_amost = 1000; % Frequencia de amostragem [Hz] = [amostras/seg].
...
ciclos = 1; % Quantidade de ciclos completos do sinal.
...
duty_cycle = 80;  % Ciclo ativo do sinal (parte alta) [%].
